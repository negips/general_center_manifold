...
In the adjoint case, for any eigenpair $(\lambda^{*},\vecw)$ of the original adjoint operator $\Lu^{\dagger}$, the corresponding eigenpair of the extended operator $\ExtL^{\dagger}$ is given by $(\lambda^{*}, [\vfield{w}; \vfield{\zeta}^{P}; \vfield{\zeta}^{H}])$, with,
\begin{subequations}
	\begin{eqnarray}
