...
If the original linear system $\Lu$ is non-singular then, the strcuture of the $p$ parameter eigenpairs is given by $\Tuple{\lambda^{P}_{i}, \EDevec^{P}_{i}}$, which satisfy
\begin{subequations}
