...
\begin{align}
	...
	\begin{split}
		\sum^{m}_{\alpha=1}\dfrac{\partial }{\partial x_{\alpha}}\Big(\sum^{[1,m]}_{(1)}\yhatbf_{i_{1}}x_{i_{1}} + \ldots \Big)	 \Big(\sum^{[1,m]}_{(1)}\AsParam^{\alpha}_{i_{1}}x_{i_{1}} +\ldots \Big)= \\
		%
		\ExtL\Big(\sum^{[1,m]}_{(1)}\yhatbf_{i_{1}}x_{i_{1}} + \ldots \Big)  +
		% 
		\Big(\sum^{[1,m]}_{(2)}\efield{f}_{i_{1},i_{2}}x_{i_{1}}x_{i_{2}} + \ldots\Big).
...
\begin{align}
	\label{eqn:asymptotic_solutions_O1}
		\sum^{m}_{\alpha=1}\Big(\yhatbf_{\alpha} \sum^{[1,m]}_{(1)}\AsParam^{\alpha}_{i_{1}}x_{i_{1}} \Big)= 
		%
		\ExtL\Big(\sum^{[1,m]}_{(1)}\yhatbf_{i_{1}}x_{i_{1}}\Big)  \nonumber \\
		%
		\implies \sum^{[1,m]}_{(1)}\Big( \sum^{m}_{\alpha=1}\yhatbf_{\alpha}\AsParam^{\alpha}_{i_{1}} - \ExtL\yhatbf_{i_{1}} \Big)= \veczero		 \nonumber 
\end{align}
