...
λ           = CenterManifold.GenerateSymbols(λstr,n)  # Original eigenvalues
ΓP          = CenterManifold.GenerateSymMatrix(Γstr,n,l;super=1,ifreal=false)
ΓH          = CenterManifold.GenerateSymMatrix(Γstr,n,h;super=2,ifreal=false)
